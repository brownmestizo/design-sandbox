...
abstract class TblEra implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\TblEraTableMap';
    ...
    /**
     * Initializes internal state of Base\TblEra object.
     */
    ...
    /**
     * Compares this with another <code>TblEra</code> instance.  If
     * <code>obj</code> is an instance of <code>TblEra</code>, delegates to
     * <code>equals(TblEra)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|TblEra The current object, for fluid interface
     */
    ...
    public function setEraId($v)
    {
        ...
        if ($this->era_id !== $v) {
            $this->era_id = $v;
            $this->modifiedColumns[TblEraTableMap::COL_ERA_ID] = true;
        }
    ...
    public function setEraDescription($v)
    {
        ...
        if ($this->era_description !== $v) {
            ...
            $this->modifiedColumns[TblEraTableMap::COL_ERA_DESCRIPTION] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : TblEraTableMap::translateFieldName('EraId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->era_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : TblEraTableMap::translateFieldName('EraDescription', TableMap::TYPE_PHPNAME, $indexType)];
            $this->era_description = (null !== $col) ? (string) $col : null;
            $this->resetModified();
            ...
            return $startcol + 2; // 2 = TblEraTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\TblEra'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildTblEraQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see TblEra::setDeleted()
     * @see TblEra::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildTblEraQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                TblEraTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(TblEraTableMap::COL_ERA_ID)) {
            $modifiedColumns[':p' . $index++]  = 'era_id';
        }
        if ($this->isColumnModified(TblEraTableMap::COL_ERA_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = 'era_description';
        }

        $sql = sprintf(
            'INSERT INTO tbl_era (%s) VALUES (%s)',
    ...
    {
        $pos = TblEraTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['TblEra'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['TblEra'][$this->hashCode()] = true;
        $keys = TblEraTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getEraId(),
            $keys[1] => $this->getEraDescription(),
        );
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setEraId($arr[$keys[0]]);
        }
        if (array_key_exists($keys[1], $arr)) {
            $this->setEraDescription($arr[$keys[1]]);
        }
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TblEraTableMap::COL_ERA_ID)) {
            $criteria->add(TblEraTableMap::COL_ERA_ID, $this->era_id);
        }
        if ($this->isColumnModified(TblEraTableMap::COL_ERA_DESCRIPTION)) {
            $criteria->add(TblEraTableMap::COL_ERA_DESCRIPTION, $this->era_description);
        }
    ...
    {
        $criteria = ChildTblEraQuery::create();
        $criteria->add(TblEraTableMap::COL_ERA_ID, $this->era_id);
    ...
    /**
     * Generic method to set the primary key (era_id column).
     *
     ...
     * objects.
     *
     * @param      object $copyObj An object of \TblEra (or compatible) type.
    ...
    {
        $copyObj->setEraDescription($this->getEraDescription());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setEraId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \TblEra Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildTblEra is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildTblEra The current object (for fluent API support)
     */
    public function setTblProdInfos(Collection $tblProdInfos, ConnectionInterface $con = null)
    {
        ...
        foreach ($tblProdInfosToDelete as $tblProdInfoRemoved) {
            $tblProdInfoRemoved->setTblEra(null);
        }
     ...
     * Otherwise if this TblEra is new, it will return
     * an empty collection; or if this TblEra has previously
     * been saved, it will retrieve related TblProdInfos from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TblEra.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
    ...
    {
        return (string) $this->exportTo(TblEraTableMap::DEFAULT_STRING_FORMAT);
    }
