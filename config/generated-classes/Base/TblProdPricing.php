...
abstract class TblProdPricing implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\TblProdPricingTableMap';
    ...
    /**
     * Initializes internal state of Base\TblProdPricing object.
     */
    ...
    /**
     * Compares this with another <code>TblProdPricing</code> instance.  If
     * <code>obj</code> is an instance of <code>TblProdPricing</code>, delegates to
     * <code>equals(TblProdPricing)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|TblProdPricing The current object, for fluid interface
     */
    ...
    {
        return $this->prod_price_description;
    }
    ...
    public function setProdPriceId($v)
    {
        ...
        if ($this->prod_price_id !== $v) {
            ...
            $this->modifiedColumns[TblProdPricingTableMap::COL_PROD_PRICE_ID] = true;
        }
     ...
     * @return $this|\TblProdPricing The current object (for fluent API support)
     */
    public function setProdPriceName($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->prod_price_name !== $v) {
            $this->prod_price_name = $v;
            $this->modifiedColumns[TblProdPricingTableMap::COL_PROD_PRICE_NAME] = true;
        }
     ...
     * @return $this|\TblProdPricing The current object (for fluent API support)
     */
    public function setProdPriceDescription($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->prod_price_description !== $v) {
            $this->prod_price_description = $v;
            $this->modifiedColumns[TblProdPricingTableMap::COL_PROD_PRICE_DESCRIPTION] = true;
        }

        return $this;
    } // setProdPriceDescription()
     ...
     * @return $this|\TblProdPricing The current object (for fluent API support)
     */
    public function setProdPricePrice($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->prod_price_price !== $v) {
            $this->prod_price_price = $v;
            $this->modifiedColumns[TblProdPricingTableMap::COL_PROD_PRICE_PRICE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : TblProdPricingTableMap::translateFieldName('ProdPriceId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->prod_price_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : TblProdPricingTableMap::translateFieldName('ProdPriceName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->prod_price_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : TblProdPricingTableMap::translateFieldName('ProdPriceDescription', TableMap::TYPE_PHPNAME, $indexType)];
            $this->prod_price_description = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : TblProdPricingTableMap::translateFieldName('ProdPricePrice', TableMap::TYPE_PHPNAME, $indexType)];
            $this->prod_price_price = (null !== $col) ? (string) $col : null;
            $this->resetModified();
            ...
            return $startcol + 4; // 4 = TblProdPricingTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\TblProdPricing'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildTblProdPricingQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see TblProdPricing::setDeleted()
     * @see TblProdPricing::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildTblProdPricingQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                TblProdPricingTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(TblProdPricingTableMap::COL_PROD_PRICE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'prod_price_id';
        }
        if ($this->isColumnModified(TblProdPricingTableMap::COL_PROD_PRICE_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'prod_price_name';
        }
        if ($this->isColumnModified(TblProdPricingTableMap::COL_PROD_PRICE_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = 'prod_price_description';
        }
        if ($this->isColumnModified(TblProdPricingTableMap::COL_PROD_PRICE_PRICE)) {
            $modifiedColumns[':p' . $index++]  = 'prod_price_price';
        }

        $sql = sprintf(
            'INSERT INTO tbl_prod_pricing (%s) VALUES (%s)',
    ...
    {
        $pos = TblProdPricingTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                return $this->getProdPriceName();
                break;
            case 2:
                return $this->getProdPriceDescription();
                break;
            case 3:
                return $this->getProdPricePrice();
                break;
            default:
                return null;
                break;
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['TblProdPricing'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['TblProdPricing'][$this->hashCode()] = true;
        $keys = TblProdPricingTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getProdPriceId(),
            $keys[1] => $this->getProdPriceName(),
            $keys[2] => $this->getProdPriceDescription(),
            $keys[3] => $this->getProdPricePrice(),
        );
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                $this->setProdPriceName($value);
                break;
            case 2:
                $this->setProdPriceDescription($value);
                break;
            case 3:
                $this->setProdPricePrice($value);
                break;
        } // switch()
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setProdPriceId($arr[$keys[0]]);
        }
        if (array_key_exists($keys[1], $arr)) {
            $this->setProdPriceName($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setProdPriceDescription($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setProdPricePrice($arr[$keys[3]]);
        }
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TblProdPricingTableMap::COL_PROD_PRICE_ID)) {
            $criteria->add(TblProdPricingTableMap::COL_PROD_PRICE_ID, $this->prod_price_id);
        }
        if ($this->isColumnModified(TblProdPricingTableMap::COL_PROD_PRICE_NAME)) {
            $criteria->add(TblProdPricingTableMap::COL_PROD_PRICE_NAME, $this->prod_price_name);
        }
        if ($this->isColumnModified(TblProdPricingTableMap::COL_PROD_PRICE_DESCRIPTION)) {
            $criteria->add(TblProdPricingTableMap::COL_PROD_PRICE_DESCRIPTION, $this->prod_price_description);
        }
        if ($this->isColumnModified(TblProdPricingTableMap::COL_PROD_PRICE_PRICE)) {
            $criteria->add(TblProdPricingTableMap::COL_PROD_PRICE_PRICE, $this->prod_price_price);
        }
    ...
    {
        $criteria = ChildTblProdPricingQuery::create();
        $criteria->add(TblProdPricingTableMap::COL_PROD_PRICE_ID, $this->prod_price_id);
    ...
    {
        $validPk = null !== $this->getProdPriceId();
    ...
    /**
     * Generic method to set the primary key (prod_price_id column).
     *
    ...
    {
        return null === $this->getProdPriceId();
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \TblProdPricing (or compatible) type.
    ...
    {
        $copyObj->setProdPriceName($this->getProdPriceName());
        $copyObj->setProdPriceDescription($this->getProdPriceDescription());
        $copyObj->setProdPricePrice($this->getProdPricePrice());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setProdPriceId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \TblProdPricing Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildTblProdPricing is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildTblProdPricing The current object (for fluent API support)
     */
    public function setTblProdInfos(Collection $tblProdInfos, ConnectionInterface $con = null)
    {
        ...
        foreach ($tblProdInfosToDelete as $tblProdInfoRemoved) {
            $tblProdInfoRemoved->setTblProdPricing(null);
        }
    ...
    protected function doAddTblProdInfo(ChildTblProdInfo $tblProdInfo)
    {
        ...
        $tblProdInfo->setTblProdPricing($this);
    }
    ...
    public function removeTblProdInfo(ChildTblProdInfo $tblProdInfo)
    {
        if ($this->getTblProdInfos()->contains($tblProdInfo)) {
            ...
            $tblProdInfo->setTblProdPricing(null);
        }
     ...
     * Otherwise if this TblProdPricing is new, it will return
     * an empty collection; or if this TblProdPricing has previously
     * been saved, it will retrieve related TblProdInfos from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TblProdPricing.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
    ...
    public function clear()
    {
        ...
        $this->prod_price_name = null;
        $this->prod_price_description = null;
        $this->prod_price_price = null;
        $this->alreadyInSave = false;
        $this->clearAllReferences();
        $this->resetModified();
        $this->setNew(true);
    ...
    {
        return (string) $this->exportTo(TblProdPricingTableMap::DEFAULT_STRING_FORMAT);
    }
