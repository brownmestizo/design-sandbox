...
abstract class TblProdShipping implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\TblProdShippingTableMap';
    ...
    /**
     * Initializes internal state of Base\TblProdShipping object.
     */
    ...
    /**
     * Compares this with another <code>TblProdShipping</code> instance.  If
     * <code>obj</code> is an instance of <code>TblProdShipping</code>, delegates to
     * <code>equals(TblProdShipping)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|TblProdShipping The current object, for fluid interface
     */
    ...
    {
        return $this->prod_shipping_description;
    }
    ...
    public function setProdShippingPriceId($v)
    {
        ...
        if ($this->prod_shipping_price_id !== $v) {
            ...
            $this->modifiedColumns[TblProdShippingTableMap::COL_PROD_SHIPPING_PRICE_ID] = true;
        }
    ...
    public function setProdShippingName($v)
    {
        ...
        if ($this->prod_shipping_name !== $v) {
            ...
            $this->modifiedColumns[TblProdShippingTableMap::COL_PROD_SHIPPING_NAME] = true;
        }
     ...
     * @return $this|\TblProdShipping The current object (for fluent API support)
     */
    public function setProdShippingDescription($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->prod_shipping_description !== $v) {
            $this->prod_shipping_description = $v;
            $this->modifiedColumns[TblProdShippingTableMap::COL_PROD_SHIPPING_DESCRIPTION] = true;
        }

        return $this;
    } // setProdShippingDescription()
    ...
    public function setProdShippingAsia($v)
    {
        ...
        if ($this->prod_shipping_asia !== $v) {
            ...
            $this->modifiedColumns[TblProdShippingTableMap::COL_PROD_SHIPPING_ASIA] = true;
        }
    ...
    public function setProdShippingEurope($v)
    {
        ...
        if ($this->prod_shipping_europe !== $v) {
            ...
            $this->modifiedColumns[TblProdShippingTableMap::COL_PROD_SHIPPING_EUROPE] = true;
        }
    ...
    public function setProdShippingUsa($v)
    {
        ...
        if ($this->prod_shipping_usa !== $v) {
            ...
            $this->modifiedColumns[TblProdShippingTableMap::COL_PROD_SHIPPING_USA] = true;
        }
    ...
    public function setProdShippingCanada($v)
    {
        ...
        if ($this->prod_shipping_canada !== $v) {
            ...
            $this->modifiedColumns[TblProdShippingTableMap::COL_PROD_SHIPPING_CANADA] = true;
        }
    ...
    public function setProdShippingAu($v)
    {
        ...
        if ($this->prod_shipping_au !== $v) {
            ...
            $this->modifiedColumns[TblProdShippingTableMap::COL_PROD_SHIPPING_AU] = true;
        }
    ...
    public function setProdShippingAsiaParcel($v)
    {
        ...
        if ($this->prod_shipping_asia_parcel !== $v) {
            ...
            $this->modifiedColumns[TblProdShippingTableMap::COL_PROD_SHIPPING_ASIA_PARCEL] = true;
        }
    ...
    public function setProdShippingEuropeParcel($v)
    {
        ...
        if ($this->prod_shipping_europe_parcel !== $v) {
            ...
            $this->modifiedColumns[TblProdShippingTableMap::COL_PROD_SHIPPING_EUROPE_PARCEL] = true;
        }
    ...
    public function setProdShippingUsaParcel($v)
    {
        ...
        if ($this->prod_shipping_usa_parcel !== $v) {
            ...
            $this->modifiedColumns[TblProdShippingTableMap::COL_PROD_SHIPPING_USA_PARCEL] = true;
        }
    ...
    public function setProdShippingCanadaParcel($v)
    {
        ...
        if ($this->prod_shipping_canada_parcel !== $v) {
            ...
            $this->modifiedColumns[TblProdShippingTableMap::COL_PROD_SHIPPING_CANADA_PARCEL] = true;
        }
    ...
    public function setProdShippingAuParcel($v)
    {
        ...
        if ($this->prod_shipping_au_parcel !== $v) {
            ...
            $this->modifiedColumns[TblProdShippingTableMap::COL_PROD_SHIPPING_AU_PARCEL] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : TblProdShippingTableMap::translateFieldName('ProdShippingPriceId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->prod_shipping_price_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : TblProdShippingTableMap::translateFieldName('ProdShippingName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->prod_shipping_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : TblProdShippingTableMap::translateFieldName('ProdShippingDescription', TableMap::TYPE_PHPNAME, $indexType)];
            $this->prod_shipping_description = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : TblProdShippingTableMap::translateFieldName('ProdShippingAsia', TableMap::TYPE_PHPNAME, $indexType)];
            $this->prod_shipping_asia = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : TblProdShippingTableMap::translateFieldName('ProdShippingEurope', TableMap::TYPE_PHPNAME, $indexType)];
            $this->prod_shipping_europe = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : TblProdShippingTableMap::translateFieldName('ProdShippingUsa', TableMap::TYPE_PHPNAME, $indexType)];
            $this->prod_shipping_usa = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : TblProdShippingTableMap::translateFieldName('ProdShippingCanada', TableMap::TYPE_PHPNAME, $indexType)];
            $this->prod_shipping_canada = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : TblProdShippingTableMap::translateFieldName('ProdShippingAu', TableMap::TYPE_PHPNAME, $indexType)];
            $this->prod_shipping_au = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : TblProdShippingTableMap::translateFieldName('ProdShippingAsiaParcel', TableMap::TYPE_PHPNAME, $indexType)];
            $this->prod_shipping_asia_parcel = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : TblProdShippingTableMap::translateFieldName('ProdShippingEuropeParcel', TableMap::TYPE_PHPNAME, $indexType)];
            $this->prod_shipping_europe_parcel = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : TblProdShippingTableMap::translateFieldName('ProdShippingUsaParcel', TableMap::TYPE_PHPNAME, $indexType)];
            $this->prod_shipping_usa_parcel = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : TblProdShippingTableMap::translateFieldName('ProdShippingCanadaParcel', TableMap::TYPE_PHPNAME, $indexType)];
            $this->prod_shipping_canada_parcel = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : TblProdShippingTableMap::translateFieldName('ProdShippingAuParcel', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 13; // 13 = TblProdShippingTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\TblProdShipping'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildTblProdShippingQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see TblProdShipping::setDeleted()
     * @see TblProdShipping::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildTblProdShippingQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                TblProdShippingTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(TblProdShippingTableMap::COL_PROD_SHIPPING_PRICE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'prod_shipping_price_id';
        }
        if ($this->isColumnModified(TblProdShippingTableMap::COL_PROD_SHIPPING_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'prod_shipping_name';
        }
        if ($this->isColumnModified(TblProdShippingTableMap::COL_PROD_SHIPPING_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = 'prod_shipping_description';
        }
        if ($this->isColumnModified(TblProdShippingTableMap::COL_PROD_SHIPPING_ASIA)) {
            $modifiedColumns[':p' . $index++]  = 'prod_shipping_asia';
        }
        if ($this->isColumnModified(TblProdShippingTableMap::COL_PROD_SHIPPING_EUROPE)) {
            $modifiedColumns[':p' . $index++]  = 'prod_shipping_europe';
        }
        if ($this->isColumnModified(TblProdShippingTableMap::COL_PROD_SHIPPING_USA)) {
            $modifiedColumns[':p' . $index++]  = 'prod_shipping_usa';
        }
        if ($this->isColumnModified(TblProdShippingTableMap::COL_PROD_SHIPPING_CANADA)) {
            $modifiedColumns[':p' . $index++]  = 'prod_shipping_canada';
        }
        if ($this->isColumnModified(TblProdShippingTableMap::COL_PROD_SHIPPING_AU)) {
            $modifiedColumns[':p' . $index++]  = 'prod_shipping_au';
        }
        if ($this->isColumnModified(TblProdShippingTableMap::COL_PROD_SHIPPING_ASIA_PARCEL)) {
            $modifiedColumns[':p' . $index++]  = 'prod_shipping_asia_parcel';
        }
        if ($this->isColumnModified(TblProdShippingTableMap::COL_PROD_SHIPPING_EUROPE_PARCEL)) {
            $modifiedColumns[':p' . $index++]  = 'prod_shipping_europe_parcel';
        }
        if ($this->isColumnModified(TblProdShippingTableMap::COL_PROD_SHIPPING_USA_PARCEL)) {
            $modifiedColumns[':p' . $index++]  = 'prod_shipping_usa_parcel';
        }
        if ($this->isColumnModified(TblProdShippingTableMap::COL_PROD_SHIPPING_CANADA_PARCEL)) {
            $modifiedColumns[':p' . $index++]  = 'prod_shipping_canada_parcel';
        }
        if ($this->isColumnModified(TblProdShippingTableMap::COL_PROD_SHIPPING_AU_PARCEL)) {
            $modifiedColumns[':p' . $index++]  = 'prod_shipping_au_parcel';
        }

        $sql = sprintf(
            'INSERT INTO tbl_prod_shipping (%s) VALUES (%s)',
    ...
    {
        $pos = TblProdShippingTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            ...
            case 1:
                ...
                break;
            case 2:
                return $this->getProdShippingDescription();
                break;
            case 3:
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['TblProdShipping'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['TblProdShipping'][$this->hashCode()] = true;
        $keys = TblProdShippingTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getProdShippingPriceId(),
            $keys[1] => $this->getProdShippingName(),
            $keys[2] => $this->getProdShippingDescription(),
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            ...
            case 1:
                ...
                break;
            case 2:
                $this->setProdShippingDescription($value);
                break;
            case 3:
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) {
            $this->setProdShippingDescription($arr[$keys[2]]);
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TblProdShippingTableMap::COL_PROD_SHIPPING_PRICE_ID)) {
            $criteria->add(TblProdShippingTableMap::COL_PROD_SHIPPING_PRICE_ID, $this->prod_shipping_price_id);
        }
        if ($this->isColumnModified(TblProdShippingTableMap::COL_PROD_SHIPPING_NAME)) {
            $criteria->add(TblProdShippingTableMap::COL_PROD_SHIPPING_NAME, $this->prod_shipping_name);
        }
        if ($this->isColumnModified(TblProdShippingTableMap::COL_PROD_SHIPPING_DESCRIPTION)) {
            $criteria->add(TblProdShippingTableMap::COL_PROD_SHIPPING_DESCRIPTION, $this->prod_shipping_description);
        }
        if ($this->isColumnModified(TblProdShippingTableMap::COL_PROD_SHIPPING_ASIA)) {
            $criteria->add(TblProdShippingTableMap::COL_PROD_SHIPPING_ASIA, $this->prod_shipping_asia);
        }
        if ($this->isColumnModified(TblProdShippingTableMap::COL_PROD_SHIPPING_EUROPE)) {
            $criteria->add(TblProdShippingTableMap::COL_PROD_SHIPPING_EUROPE, $this->prod_shipping_europe);
        }
        if ($this->isColumnModified(TblProdShippingTableMap::COL_PROD_SHIPPING_USA)) {
            $criteria->add(TblProdShippingTableMap::COL_PROD_SHIPPING_USA, $this->prod_shipping_usa);
        }
        if ($this->isColumnModified(TblProdShippingTableMap::COL_PROD_SHIPPING_CANADA)) {
            $criteria->add(TblProdShippingTableMap::COL_PROD_SHIPPING_CANADA, $this->prod_shipping_canada);
        }
        if ($this->isColumnModified(TblProdShippingTableMap::COL_PROD_SHIPPING_AU)) {
            $criteria->add(TblProdShippingTableMap::COL_PROD_SHIPPING_AU, $this->prod_shipping_au);
        }
        if ($this->isColumnModified(TblProdShippingTableMap::COL_PROD_SHIPPING_ASIA_PARCEL)) {
            $criteria->add(TblProdShippingTableMap::COL_PROD_SHIPPING_ASIA_PARCEL, $this->prod_shipping_asia_parcel);
        }
        if ($this->isColumnModified(TblProdShippingTableMap::COL_PROD_SHIPPING_EUROPE_PARCEL)) {
            $criteria->add(TblProdShippingTableMap::COL_PROD_SHIPPING_EUROPE_PARCEL, $this->prod_shipping_europe_parcel);
        }
        if ($this->isColumnModified(TblProdShippingTableMap::COL_PROD_SHIPPING_USA_PARCEL)) {
            $criteria->add(TblProdShippingTableMap::COL_PROD_SHIPPING_USA_PARCEL, $this->prod_shipping_usa_parcel);
        }
        if ($this->isColumnModified(TblProdShippingTableMap::COL_PROD_SHIPPING_CANADA_PARCEL)) {
            $criteria->add(TblProdShippingTableMap::COL_PROD_SHIPPING_CANADA_PARCEL, $this->prod_shipping_canada_parcel);
        }
        if ($this->isColumnModified(TblProdShippingTableMap::COL_PROD_SHIPPING_AU_PARCEL)) {
            $criteria->add(TblProdShippingTableMap::COL_PROD_SHIPPING_AU_PARCEL, $this->prod_shipping_au_parcel);
        }
    ...
    {
        $criteria = ChildTblProdShippingQuery::create();
        $criteria->add(TblProdShippingTableMap::COL_PROD_SHIPPING_PRICE_ID, $this->prod_shipping_price_id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \TblProdShipping (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setProdShippingDescription($this->getProdShippingDescription());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \TblProdShipping Clone of current object.
     * @throws PropelException
     */
    ...
    public function clear()
    {
        ...
        $this->prod_shipping_description = null;
    ...
    {
        return (string) $this->exportTo(TblProdShippingTableMap::DEFAULT_STRING_FORMAT);
    }
